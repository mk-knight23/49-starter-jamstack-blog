...
const state = require('./vite-ssg.CjsEygxB.cjs');
...
async function build(ssgOptions = {}, viteConfig = {}) {
  ...
  const _require = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('shared/vite-ssg.B6xKWpjw.cjs', document.baseURI).href)));
